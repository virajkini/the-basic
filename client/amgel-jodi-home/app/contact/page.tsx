            ...
            <div className="space-y-8">
              ...
              <div className="bg-myColor-900 rounded-2xl p-8 text-white">
                ...
                <div className="flex gap-4">
                  <a href="https://www.instagram.com/amgel_jodi/" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-white/10 hover:bg-white/20 rounded-xl flex items-center justify-center transition-colors" aria-label="Instagram">
                  ...
                  <a href="https://www.facebook.com/profile.php?id=61576507635393" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-white/10 hover:bg-white/20 rounded-xl flex items-center justify-center transition-colors" aria-label="Facebook">
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
